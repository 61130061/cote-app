...
export default function HomeQuick () {
   return (
      <div className="flex flex-col gap-5 bg-zinc-700 rounded-md p-10">
         <div className="font-bold">Quick Menu</div>
         ...
         <div className="flex gap-3 items-center hover:cursor-pointer">
            ...
            <div>
               <div className="text-blue-400">New Note</div>
         ...
         <div className="flex gap-3 items-center hover:cursor-pointer">
            ...
            <div>
               <div className="text-blue-400">New Collection</div>
               <div className="text-sm text-gray-400">descripttion for this menu</div>
            </div>
         </div>
